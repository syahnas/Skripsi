...
<head>
    ...
    <script defer="" referrerpolicy="origin"
        src="/cdn-cgi/zaraz/s.js?z=">
    </script>
    ...
    <div class="login-box">
        ...
        <div class="card card-outline card-primary">
            <div class="card-header text-center">
                <a href="{{asset('AdminLTE/index2.html')}}" class="h1"><b>REKOMENDASI PROGRAM STUDI</a>
            </div>
            <div class="card-body">
                ...
                <form action="/register" method="post">
                    ...
                    <input type="hidden" class="form-control" name="level" placeholder="Level" value="Maba">
                    <div class="row">
                        <div class="col-8">
